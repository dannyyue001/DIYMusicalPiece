...
const SONGS = [
  ...
  {
    id: 9, title: "一笑江湖", category: "pop", difficulty: "中等", isNew: false,
    description: "古风，旋律优美。",
  ...
  {
    id: 10, title: "千与千寻", category: "classical", difficulty: "中等", isNew: false,
    description: "久石让经典之作，空灵治愈。旋律如流水般连贯，弹起来有种说不出的宁静感。",
    keys: "3 4 5-5-5- 5 6 5 4| 3- 3- 3- 3 4 3 2 1[7] |[6]-[6]- 1 2 [5] 1 2 3 4-| 3 2 1 1",
    tips: "这首整体要弹得柔和连贯，音与音之间不要断开，想象自己在轻轻唱出每个音。",
    techniques: ["[7] 和 [6] 是低八度的 Si 和 La，出现前提前把手移过去", "5-5-5- 三个音拖长且力度渐弱，不要弹成三个等长的顿音", "遇到连续下行（如 5 6 5 4）放慢练，确保每个音都落稳再走"],
    tags: ["改编", "动漫", "治愈", "经典"],
  },
  {
  id: 11, title: "穷开心", category: "pop", difficulty: "简单", isNew: true,
    description: "小乐队的洗脑神曲，旋律简单重复，跟着哼几遍就能弹，弹起来特别解压。",
    keys: "3 2 3 1 1| [6] [6] [6] 3 2 2 | 2 3 5 3 2 1 3 1 1| 3 2 3 1 1 | [6] [6] [6] 3 2 2 | 2 3 2 1 [5] [6] | 1 1 1 ]",
    tips: "节奏偏欢快跳跃，每个音弹得短促有力，不要拖，跟着歌里的鼓点感走最稳。",
    techniques: ["[6] 和 [5] 是低八度的 La 和 Sol，出现前手提前往左挪", "整首节奏型基本固定，先把第一句练熟，后面大部分是重复", "弹的时候可以跟着默唱歌词，有助于找准每个音的长短"],
    tags: ["流行", "热门", "解压"],
  },
];
